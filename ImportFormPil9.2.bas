...
' Stat row labels via Chr() to avoid encoding issues
Private Function LBL_TOTAL() As String: LBL_TOTAL = Chr(214) & "sszeg": End Function
Private Function LBL_AVG()   As String: LBL_AVG   = Chr(193) & "tlag":  End Function
Private Function LBL_MAX()   As String: LBL_MAX   = "Maximum":           End Function
Private Function LBL_MIN()   As String: LBL_MIN   = "Minimum":           End Function
...
Private Function ImportOneFile(wbSrc As Workbook, wbDst As Workbook, _
    ...
    ' --- Write header row -------------------------------------------
    wsNew.Cells(1, DC_IDOSZAK).Value   = "Id" & Chr(337) & "szak"
    wsNew.Cells(1, DC_C).Value         = "Fogadott h" & Chr(237) & "v" & Chr(225) & "sok"
    wsNew.Cells(1, DC_K).Value         = "V" & Chr(225) & "rakoz" & Chr(225) & "s n" & Chr(233) & "lk" & Chr(252) & "l kiszolg" & Chr(225) & "lt"
    wsNew.Cells(1, DC_L).Value         = "V" & Chr(225) & "rakoz" & Chr(225) & "s ut" & Chr(225) & "n kiszolg" & Chr(225) & "lt"
    wsNew.Cells(1, DC_T).Value         = "Munkat" & Chr(225) & "rs " & Chr(225) & "ltal kiszolg" & Chr(225) & "lt"
    wsNew.Cells(1, DC_AJ).Value        = Chr(220) & "dv" & Chr(246) & "zl" & Chr(337) & " hangbemond" & Chr(225) & "s"
    wsNew.Cells(1, DC_AU).Value        = "H" & Chr(237) & "v" & Chr(225) & "selveszt" & Chr(233) & "sek teljes sz" & Chr(225) & "ma"
    wsNew.Cells(1, DC_SZV_PCT).Value   = "Szolg" & Chr(225) & "ltat" & Chr(225) & "si sz" & Chr(237) & "nvonal 30 mp (%)"
    wsNew.Cells(1, DC_SZV_DB).Value    = "Szolg" & Chr(225) & "ltat" & Chr(225) & "si sz" & Chr(237) & "nvonal 30 mp (db)"
    wsNew.Cells(1, DC_MEGV_PCT).Value  = "Megv" & Chr(225) & "laszol" & Chr(225) & "si ar" & Chr(225) & "ny (%)"
    wsNew.Cells(1, DC_VESZT_DB).Value  = "Vesztett h" & Chr(237) & "v" & Chr(225) & "s (db)"
    wsNew.Cells(1, DC_VESZT_PCT).Value = "Vesztett h" & Chr(237) & "v" & Chr(225) & "s (%)"
...
Private Sub BuildSummary(wbDst As Workbook, sheetNames() As String, sheetCount As Integer)
    ...
    ' Header row
    wsSumm.Cells(1, DC_IDOSZAK).Value   = "Id" & Chr(337) & "szak"
    wsSumm.Cells(1, DC_C).Value         = "Fogadott h" & Chr(237) & "v" & Chr(225) & "sok"
    wsSumm.Cells(1, DC_K).Value         = "V" & Chr(225) & "rakoz" & Chr(225) & "s n" & Chr(233) & "lk" & Chr(252) & "l kiszolg" & Chr(225) & "lt"
    wsSumm.Cells(1, DC_L).Value         = "V" & Chr(225) & "rakoz" & Chr(225) & "s ut" & Chr(225) & "n kiszolg" & Chr(225) & "lt"
    wsSumm.Cells(1, DC_T).Value         = "Munkat" & Chr(225) & "rs " & Chr(225) & "ltal kiszolg" & Chr(225) & "lt"
    wsSumm.Cells(1, DC_AJ).Value        = Chr(220) & "dv" & Chr(246) & "zl" & Chr(337) & " hangbemond" & Chr(225) & "s"
    wsSumm.Cells(1, DC_AU).Value        = "H" & Chr(237) & "v" & Chr(225) & "selveszt" & Chr(233) & "sek teljes sz" & Chr(225) & "ma"
    wsSumm.Cells(1, DC_SZV_PCT).Value   = "Szolg" & Chr(225) & "ltat" & Chr(225) & "si sz" & Chr(237) & "nvonal 30 mp (%)"
    wsSumm.Cells(1, DC_SZV_DB).Value    = "Szolg" & Chr(225) & "ltat" & Chr(225) & "si sz" & Chr(237) & "nvonal 30 mp (db)"
    wsSumm.Cells(1, DC_MEGV_PCT).Value  = "Megv" & Chr(225) & "laszol" & Chr(225) & "si ar" & Chr(225) & "ny (%)"
    wsSumm.Cells(1, DC_VESZT_DB).Value  = "Vesztett h" & Chr(237) & "v" & Chr(225) & "s (db)"
    wsSumm.Cells(1, DC_VESZT_PCT).Value = "Vesztett h" & Chr(237) & "v" & Chr(225) & "s (%)"
