...
Private Function ImportOneFile(wbSrc As Workbook, wbDst As Workbook, _
    ...
    For statRow = 0 To 3
        ...
        For c = 2 To TOTAL_COLS - 1
            ...
            Select Case statRow
                Case 0: formula = "=IFERROR(SUM("    & rangeAddr & "),"""")"
                Case 1: formula = "=IFERROR(AVERAGE(" & rangeAddr & "),"""")"
            ...
            statCell.NumberFormat = dataFmts(c)  ' c here = dstCol index (1-based, col B onwards)
        Next c
    ...
    For ri = 0 To rowCount - 1
        ...
        ' Hide row if all data columns are empty/zero
