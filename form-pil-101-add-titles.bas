...
Private Function ImportOneFile(wbSrc As Workbook, wbDst As Workbook, _
    ...
    wsNew.Cells(OUT_HDR_ROWS, DC_IDOSZAK).Value   = "Időszak"
    wsNew.Cells(OUT_HDR_ROWS, DC_C).Value         = "Fogadott hívások"
    wsNew.Cells(OUT_HDR_ROWS, DC_K).Value         = "Várakozás nélkül kiszolgált"
    wsNew.Cells(OUT_HDR_ROWS, DC_L).Value         = "Várakozás után kiszolgált"
    wsNew.Cells(OUT_HDR_ROWS, DC_T).Value         = "Munkatárs által kiszolgált"
    wsNew.Cells(OUT_HDR_ROWS, DC_AJ).Value        = "Üdvözlő hangbemondás"
    wsNew.Cells(OUT_HDR_ROWS, DC_AU).Value        = "Híváselvesztések teljes száma"
    wsNew.Cells(OUT_HDR_ROWS, DC_SZV_PCT).Value   = "Szolgáltatási színvonal 30 mp (%)"
    wsNew.Cells(OUT_HDR_ROWS, DC_SZV_DB).Value    = "Szolgáltatási színvonal 30 mp (db)"
    wsNew.Cells(OUT_HDR_ROWS, DC_MEGV_PCT).Value  = "Megválaszolási arány (%)"
    wsNew.Cells(OUT_HDR_ROWS, DC_VESZT_DB).Value  = "Vesztett hívás (db)"
    wsNew.Cells(OUT_HDR_ROWS, DC_VESZT_PCT).Value = "Vesztett hívás (%)"
...
Private Sub BuildSummary(wbDst As Workbook, sheetNames() As String, sheetCount As Integer)
    ...
    wsSumm.Cells(OUT_HDR_ROWS, DC_IDOSZAK).Value   = "Időszak"
    wsSumm.Cells(OUT_HDR_ROWS, DC_C).Value         = "Fogadott hívások"
    wsSumm.Cells(OUT_HDR_ROWS, DC_K).Value         = "Várakozás nélkül kiszolgált"
    wsSumm.Cells(OUT_HDR_ROWS, DC_L).Value         = "Várakozás után kiszolgált"
    wsSumm.Cells(OUT_HDR_ROWS, DC_T).Value         = "Munkatárs által kiszolgált"
    wsSumm.Cells(OUT_HDR_ROWS, DC_AJ).Value        = "Üdvözlő hangbemondás"
    wsSumm.Cells(OUT_HDR_ROWS, DC_AU).Value        = "Híváselvesztések teljes száma"
    wsSumm.Cells(OUT_HDR_ROWS, DC_SZV_PCT).Value   = "Szolgáltatási színvonal 30 mp (%)"
    wsSumm.Cells(OUT_HDR_ROWS, DC_SZV_DB).Value    = "Szolgáltatási színvonal 30 mp (db)"
    wsSumm.Cells(OUT_HDR_ROWS, DC_MEGV_PCT).Value  = "Megválaszolási arány (%)"
    wsSumm.Cells(OUT_HDR_ROWS, DC_VESZT_DB).Value  = "Vesztett hívás (db)"
    wsSumm.Cells(OUT_HDR_ROWS, DC_VESZT_PCT).Value = "Vesztett hívás (%)"
